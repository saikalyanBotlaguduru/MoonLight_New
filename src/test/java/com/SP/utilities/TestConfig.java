...
public class TestConfig{
	...
	public static String from = "botlasai@gmail.com";
	public static String password = "Sridansreyaan123+@";
	public static String[] to ={"botlasai@gmail.com","botlasai@gmail.com"};
